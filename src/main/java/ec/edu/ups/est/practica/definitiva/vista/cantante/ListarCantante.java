...
public class ListarCantante extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblCanatntes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Edad", "Nacionalida", "Salario", "Artistico", "Genero", "Discos"
            }
        ));
    ...
    private void actualizarTabla() {
        ...
        for (Cantante listaPersona : listaPersonas) {
            ...
            List<Disco> discos = listaPersona.listarDiscos(); // Obtener la lista de discos

            // Crear una cadena con los nombres de los discos separados por comas
            StringBuilder discosStr = new StringBuilder();
            for (Disco disco : discos) {
                discosStr.append(disco.getNombre()).append(", ");
            }
            if (discosStr.length() > 0) {
                discosStr.setLength(discosStr.length() - 2); // Eliminar la última coma y espacio
            }

            Object[] rowData = {id, nombre, apellido, edad, nacionalidad, salario, nombreArtistico, genero, discosStr.toString()};
